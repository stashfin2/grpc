...
var file_documents_getagreement_proto_rawDesc = []byte{
...
var (
	...
	file_documents_getagreement_proto_rawDescData = file_documents_getagreement_proto_rawDesc
)

func file_documents_getagreement_proto_rawDescGZIP() []byte {
	file_documents_getagreement_proto_rawDescOnce.Do(func() {
		file_documents_getagreement_proto_rawDescData = protoimpl.X.CompressGZIP(file_documents_getagreement_proto_rawDescData)
	})
...
var file_documents_getagreement_proto_goTypes = []interface{}{
...
func file_documents_getagreement_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_documents_getagreement_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_documents_getagreement_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_documents_getagreement_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_documents_getagreement_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_documents_getagreement_proto_rawDesc = nil
