...
var file_kyc_nsdlpanvalidate_proto_rawDesc = string([]byte{
...
var (
	...
	file_kyc_nsdlpanvalidate_proto_rawDescData []byte
)

func file_kyc_nsdlpanvalidate_proto_rawDescGZIP() []byte {
	file_kyc_nsdlpanvalidate_proto_rawDescOnce.Do(func() {
		file_kyc_nsdlpanvalidate_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_kyc_nsdlpanvalidate_proto_rawDesc), len(file_kyc_nsdlpanvalidate_proto_rawDesc)))
	})
...
var file_kyc_nsdlpanvalidate_proto_goTypes = []any{
...
func file_kyc_nsdlpanvalidate_proto_init() {
	...
	file_kyc_nsdlpanvalidate_proto_msgTypes[1].OneofWrappers = []any{}
	file_kyc_nsdlpanvalidate_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_kyc_nsdlpanvalidate_proto_rawDesc), len(file_kyc_nsdlpanvalidate_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
