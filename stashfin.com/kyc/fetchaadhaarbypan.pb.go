...
type FetchAadhaarByPanResponse struct {
	...
	Data          *FetchAadhaarByPanData `protobuf:"bytes,4,opt,name=data,proto3" json:"data,omitempty"`
...
func (x *FetchAadhaarByPanResponse) GetData() *FetchAadhaarByPanData {
	if x != nil {
		return x.Data
	}
	return nil
...
type FetchAadhaarByPanData struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *FetchAadhaarByPanData) Reset() {
	*x = FetchAadhaarByPanData{}
	mi := &file_kyc_fetchaadhaarbypan_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *FetchAadhaarByPanData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FetchAadhaarByPanData) ProtoMessage() {}

func (x *FetchAadhaarByPanData) ProtoReflect() protoreflect.Message {
	mi := &file_kyc_fetchaadhaarbypan_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FetchAadhaarByPanData.ProtoReflect.Descriptor instead.
func (*FetchAadhaarByPanData) Descriptor() ([]byte, []int) {
	return file_kyc_fetchaadhaarbypan_proto_rawDescGZIP(), []int{2}
}

func (x *FetchAadhaarByPanData) GetCode() string {
	if x != nil {
		return x.Code
	}
	return ""
...
func (x *FetchAadhaarByPanData) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *FetchAadhaarByPanData) GetPanData() *PanData {
	if x != nil {
		return x.PanData
	}
	return nil
...
var file_kyc_fetchaadhaarbypan_proto_rawDesc = string([]byte{
	...
	0xed, 0x01, 0x0a, 0x19, 0x66, 0x65, 0x74, 0x63, 0x68, 0x41, 0x61, 0x64, 0x68, 0x61, 0x61, 0x72,
	...
	,
	...
	0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x64, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e,
	0x74, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x64, 0x6f, 0x63, 0x75,
	0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x32, 0x0a, 0x15, 0x6d, 0x61, 0x73, 0x6b, 0x65, 0x64,
	0x5f, 0x61, 0x61, 0x64, 0x68, 0x61, 0x61, 0x72, 0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13, 0x6d, 0x61, 0x73, 0x6b, 0x65, 0x64, 0x41, 0x61, 0x64,
	0x68, 0x61, 0x61, 0x72, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
})

var (
	file_kyc_fetchaadhaarbypan_proto_rawDescOnce sync.Once
	file_kyc_fetchaadhaarbypan_proto_rawDescData []byte
)

func file_kyc_fetchaadhaarbypan_proto_rawDescGZIP() []byte {
	file_kyc_fetchaadhaarbypan_proto_rawDescOnce.Do(func() {
		file_kyc_fetchaadhaarbypan_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_kyc_fetchaadhaarbypan_proto_rawDesc), len(file_kyc_fetchaadhaarbypan_proto_rawDesc)))
	})
...
var file_kyc_fetchaadhaarbypan_proto_goTypes = []any{
	...
	(*FetchAadhaarByPanData)(nil),     // 2: kyc.fetchaadhaarbypan.fetchAadhaarByPanData
	(*PanData)(nil),                   // 3: kyc.fetchaadhaarbypan.PanData
}
var file_kyc_fetchaadhaarbypan_proto_depIdxs = []int32{
	2, // 0: kyc.fetchaadhaarbypan.fetchAadhaarByPanResponse.data:type_name -> kyc.fetchaadhaarbypan.fetchAadhaarByPanData
	3, // 1: kyc.fetchaadhaarbypan.fetchAadhaarByPanData.pan_data:type_name -> kyc.fetchaadhaarbypan.PanData
...
func file_kyc_fetchaadhaarbypan_proto_init() {
	...
	file_kyc_fetchaadhaarbypan_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_kyc_fetchaadhaarbypan_proto_rawDesc), len(file_kyc_fetchaadhaarbypan_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
