...
var file_payments_nachregistration_proto_rawDesc = string([]byte{
...
var (
	...
	file_payments_nachregistration_proto_rawDescData []byte
)

func file_payments_nachregistration_proto_rawDescGZIP() []byte {
	file_payments_nachregistration_proto_rawDescOnce.Do(func() {
		file_payments_nachregistration_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_payments_nachregistration_proto_rawDesc), len(file_payments_nachregistration_proto_rawDesc)))
	})
...
var file_payments_nachregistration_proto_goTypes = []any{
...
func file_payments_nachregistration_proto_init() {
	...
	file_payments_nachregistration_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_payments_nachregistration_proto_rawDesc), len(file_payments_nachregistration_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
