...
var file_eqxcustomers_sendotp_proto_rawDesc = string([]byte{
...
var (
	...
	file_eqxcustomers_sendotp_proto_rawDescData []byte
)

func file_eqxcustomers_sendotp_proto_rawDescGZIP() []byte {
	file_eqxcustomers_sendotp_proto_rawDescOnce.Do(func() {
		file_eqxcustomers_sendotp_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_eqxcustomers_sendotp_proto_rawDesc), len(file_eqxcustomers_sendotp_proto_rawDesc)))
	})
...
var file_eqxcustomers_sendotp_proto_goTypes = []any{
...
func file_eqxcustomers_sendotp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_eqxcustomers_sendotp_proto_rawDesc), len(file_eqxcustomers_sendotp_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
