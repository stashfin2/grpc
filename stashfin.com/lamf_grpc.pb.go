...
func (c *lamfClient) Validatelamfuser(ctx context.Context, in *lamf.ValidateuserRequest, opts ...grpc.CallOption) (*lamf.ValidateuserResponse, error) {
	...
	err := c.cc.Invoke(ctx, Lamf_Validatelamfuser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lamfClient) Submitlamfotp(ctx context.Context, in *lamf.SubmitotpRequest, opts ...grpc.CallOption) (*lamf.SubmitotpResponse, error) {
	...
	err := c.cc.Invoke(ctx, Lamf_Submitlamfotp_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lamfClient) Getlamfloandetails(ctx context.Context, in *lamf.GetloandetailsRequest, opts ...grpc.CallOption) (*lamf.GetloandetailsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Lamf_Getlamfloandetails_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedLamfServer must be embedded to have
...
func (UnimplementedLamfServer) testEmbeddedByValue()              {}
...
func RegisterLamfServer(s grpc.ServiceRegistrar, srv LamfServer) {
	// If the following call pancis, it indicates UnimplementedLamfServer was
