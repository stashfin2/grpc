...
var file_growth_checkplanstatus_proto_rawDesc = []byte{
...
var (
	...
	file_growth_checkplanstatus_proto_rawDescData = file_growth_checkplanstatus_proto_rawDesc
)

func file_growth_checkplanstatus_proto_rawDescGZIP() []byte {
	file_growth_checkplanstatus_proto_rawDescOnce.Do(func() {
		file_growth_checkplanstatus_proto_rawDescData = protoimpl.X.CompressGZIP(file_growth_checkplanstatus_proto_rawDescData)
	})
...
var file_growth_checkplanstatus_proto_goTypes = []interface{}{
...
func file_growth_checkplanstatus_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_growth_checkplanstatus_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Chrplansstatusrequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_growth_checkplanstatus_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_growth_checkplanstatus_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Chrplanstatusresponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_growth_checkplanstatus_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_growth_checkplanstatus_proto_rawDesc = nil
