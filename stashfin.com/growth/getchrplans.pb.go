...
var file_growth_getchrplans_proto_rawDesc = string([]byte{
...
var (
	...
	file_growth_getchrplans_proto_rawDescData []byte
)

func file_growth_getchrplans_proto_rawDescGZIP() []byte {
	file_growth_getchrplans_proto_rawDescOnce.Do(func() {
		file_growth_getchrplans_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_growth_getchrplans_proto_rawDesc), len(file_growth_getchrplans_proto_rawDesc)))
	})
	return file_growth_getchrplans_proto_rawDescData
}

var file_growth_getchrplans_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_growth_getchrplans_proto_goTypes = []any{
...
func file_growth_getchrplans_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_growth_getchrplans_proto_rawDesc), len(file_growth_getchrplans_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
