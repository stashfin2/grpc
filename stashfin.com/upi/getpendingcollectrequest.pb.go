...
type PendingCollectionData struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *PendingCollectionData) Reset() {
	*x = PendingCollectionData{}
	mi := &file_upi_getpendingcollectrequest_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PendingCollectionData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PendingCollectionData) ProtoMessage() {}

func (x *PendingCollectionData) ProtoReflect() protoreflect.Message {
	mi := &file_upi_getpendingcollectrequest_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PendingCollectionData.ProtoReflect.Descriptor instead.
func (*PendingCollectionData) Descriptor() ([]byte, []int) {
	return file_upi_getpendingcollectrequest_proto_rawDescGZIP(), []int{2}
}

func (x *PendingCollectionData) GetRequests() []*CollectRequest {
	if x != nil {
		return x.Requests
	}
	return nil
...
type PendingCollectResponse struct {
	...
	Data          *PendingCollectionData `protobuf:"bytes,3,opt,name=data,proto3,oneof" json:"data,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PendingCollectResponse) GetData() *PendingCollectionData {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_upi_getpendingcollectrequest_proto_rawDesc = string([]byte{
	...
	,
	...
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x33, 0x2e, 0x75, 0x70, 0x69, 0x2e, 0x67, 0x65, 0x74, 0x50, 0x65,
	0x6e, 0x64, 0x69, 0x6e, 0x67, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x2e, 0x70, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x43, 0x6f, 0x6c, 0x6c, 0x65,
...
var file_upi_getpendingcollectrequest_proto_goTypes = []any{
	...
	(*PendingCollectionData)(nil),  // 2: upi.getPendingCollectRequest.pendingCollectionData
...
var file_upi_getpendingcollectrequest_proto_depIdxs = []int32{
	1, // 0: upi.getPendingCollectRequest.pendingCollectionData.requests:type_name -> upi.getPendingCollectRequest.CollectRequest
	2, // 1: upi.getPendingCollectRequest.pendingCollectResponse.data:type_name -> upi.getPendingCollectRequest.pendingCollectionData
