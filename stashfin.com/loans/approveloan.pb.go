...
var file_loans_approveloan_proto_rawDesc = string([]byte{
...
var (
	...
	file_loans_approveloan_proto_rawDescData []byte
)

func file_loans_approveloan_proto_rawDescGZIP() []byte {
	file_loans_approveloan_proto_rawDescOnce.Do(func() {
		file_loans_approveloan_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_loans_approveloan_proto_rawDesc), len(file_loans_approveloan_proto_rawDesc)))
	})
	return file_loans_approveloan_proto_rawDescData
}

var file_loans_approveloan_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_loans_approveloan_proto_goTypes = []any{
...
func file_loans_approveloan_proto_init() {
	...
	file_loans_approveloan_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_loans_approveloan_proto_rawDesc), len(file_loans_approveloan_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
