...
var file_loans_sendemail_proto_rawDesc = string([]byte{
...
var (
	...
	file_loans_sendemail_proto_rawDescData []byte
)

func file_loans_sendemail_proto_rawDescGZIP() []byte {
	file_loans_sendemail_proto_rawDescOnce.Do(func() {
		file_loans_sendemail_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_loans_sendemail_proto_rawDesc), len(file_loans_sendemail_proto_rawDesc)))
	})
	return file_loans_sendemail_proto_rawDescData
}

var file_loans_sendemail_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_loans_sendemail_proto_goTypes = []any{
...
func file_loans_sendemail_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_loans_sendemail_proto_rawDesc), len(file_loans_sendemail_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
