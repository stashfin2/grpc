...
var file_loans_fcppayment_proto_rawDesc = []byte{
...
var (
	...
	file_loans_fcppayment_proto_rawDescData = file_loans_fcppayment_proto_rawDesc
)

func file_loans_fcppayment_proto_rawDescGZIP() []byte {
	file_loans_fcppayment_proto_rawDescOnce.Do(func() {
		file_loans_fcppayment_proto_rawDescData = protoimpl.X.CompressGZIP(file_loans_fcppayment_proto_rawDescData)
	})
	return file_loans_fcppayment_proto_rawDescData
}

var file_loans_fcppayment_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_loans_fcppayment_proto_goTypes = []interface{}{
...
func file_loans_fcppayment_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_loans_fcppayment_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FcpPaymentRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_loans_fcppayment_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FcpPaymentResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_loans_fcppayment_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FcpPaymentRequestAddOn); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_loans_fcppayment_proto_msgTypes[1].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_loans_fcppayment_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_loans_fcppayment_proto_rawDesc = nil
