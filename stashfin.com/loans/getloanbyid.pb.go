...
var file_loans_getloanbyid_proto_rawDesc = []byte{
...
var (
	...
	file_loans_getloanbyid_proto_rawDescData = file_loans_getloanbyid_proto_rawDesc
)

func file_loans_getloanbyid_proto_rawDescGZIP() []byte {
	file_loans_getloanbyid_proto_rawDescOnce.Do(func() {
		file_loans_getloanbyid_proto_rawDescData = protoimpl.X.CompressGZIP(file_loans_getloanbyid_proto_rawDescData)
	})
	return file_loans_getloanbyid_proto_rawDescData
}

var file_loans_getloanbyid_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_loans_getloanbyid_proto_goTypes = []interface{}{
...
func file_loans_getloanbyid_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_loans_getloanbyid_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetLoanByIdRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_loans_getloanbyid_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetLoanByIdResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_loans_getloanbyid_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetLoanByIdResponse_Field); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_loans_getloanbyid_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetLoanByIdResponse_Field_Field); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_loans_getloanbyid_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_loans_getloanbyid_proto_rawDesc = nil
