...
type WebTokenResponse struct {
	...
	Data          *WebTokenData          `protobuf:"bytes,2,opt,name=data,proto3,oneof" json:"data,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *WebTokenResponse) GetData() *WebTokenData {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *WebTokenData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WebTokenData) ProtoMessage() {}

func (x *WebTokenData) ProtoReflect() protoreflect.Message {
	mi := &file_bureau_getcibilwebtoken_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WebTokenData.ProtoReflect.Descriptor instead.
func (*WebTokenData) Descriptor() ([]byte, []int) {
	return file_bureau_getcibilwebtoken_proto_rawDescGZIP(), []int{2}
}

func (x *WebTokenData) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *WebTokenData) GetReportUrl() string {
	if x != nil {
		return x.ReportUrl
	}
	return ""
...
func (x *WebTokenData) GetWebToken() string {
	if x != nil {
		return x.WebToken
	}
	return ""
...
var file_bureau_getcibilwebtoken_proto_rawDesc = string([]byte{
	...
	0x52, 0x0a, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x49, 0x64, 0x22, 0x73, 0x0a, 0x10,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x62, 0x75, 0x72, 0x65, 0x61, 0x75, 0x2e,
	0x67, 0x65, 0x74, 0x63, 0x69, 0x62, 0x69, 0x6c, 0x77, 0x65, 0x62, 0x74, 0x6f, 0x6b, 0x65, 0x6e,
	0x2e, 0x57, 0x65, 0x62, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x44, 0x61, 0x74, 0x61, 0x48, 0x00, 0x52,
	0x04, 0x64, 0x61, 0x74, 0x61, 0x88, 0x01, 0x01, 0x42, 0x07, 0x0a, 0x05, 0x5f, 0x64, 0x61, 0x74,
	0x61, 0x22, 0x64, 0x0a, 0x0c, 0x57, 0x65, 0x62, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x44, 0x61, 0x74,
...
var file_bureau_getcibilwebtoken_proto_goTypes = []any{
	...
	(*WebTokenData)(nil),     // 2: bureau.getcibilwebtoken.WebTokenData
}
var file_bureau_getcibilwebtoken_proto_depIdxs = []int32{
	2, // 0: bureau.getcibilwebtoken.webTokenResponse.data:type_name -> bureau.getcibilwebtoken.WebTokenData
