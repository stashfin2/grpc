...
type GetBasicInfoResponse struct {
	...
	CurrAddress      *BasicInfoAddress `protobuf:"bytes,5,opt,name=curr_address,json=currAddress,proto3" json:"curr_address,omitempty"`
	PermanentAddress *BasicInfoAddress `protobuf:"bytes,6,opt,name=permanent_address,json=permanentAddress,proto3" json:"permanent_address,omitempty"`
}
...
func (x *GetBasicInfoResponse) GetCurrAddress() *BasicInfoAddress {
	if x != nil {
...
func (x *GetBasicInfoResponse) GetPermanentAddress() *BasicInfoAddress {
	if x != nil {
...
func (x *BasicInfoAddress) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BasicInfoAddress) ProtoMessage() {}

func (x *BasicInfoAddress) ProtoReflect() protoreflect.Message {
	mi := &file_customers_getbasicinfo_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BasicInfoAddress.ProtoReflect.Descriptor instead.
func (*BasicInfoAddress) Descriptor() ([]byte, []int) {
	return file_customers_getbasicinfo_proto_rawDescGZIP(), []int{2}
}

func (x *BasicInfoAddress) GetHouseFlatNo() string {
	if x != nil {
...
func (x *BasicInfoAddress) GetAddressLine_1() string {
	if x != nil {
...
func (x *BasicInfoAddress) GetAddressLine_2() string {
	if x != nil {
...
func (x *BasicInfoAddress) GetLandmark() string {
	if x != nil {
		return x.Landmark
	}
	return ""
...
func (x *BasicInfoAddress) GetCity() string {
	if x != nil {
		return x.City
	}
	return ""
...
func (x *BasicInfoAddress) GetState() string {
	if x != nil {
		return x.State
	}
	return ""
...
func (x *BasicInfoAddress) GetPinCode() string {
	if x != nil {
		return x.PinCode
	}
	return ""
...
var file_customers_getbasicinfo_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xa5, 0x02,
	...
	,
	...
	0x6c, 0x69, 0x6e, 0x65, 0x5f, 0x32, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x61, 0x64,
	0x64, 0x72, 0x65, 0x73, 0x73, 0x4c, 0x69, 0x6e, 0x65, 0x32, 0x12, 0x1a, 0x0a, 0x08, 0x6c, 0x61,
	0x6e, 0x64, 0x6d, 0x61, 0x72, 0x6b, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6c, 0x61,
	0x6e, 0x64, 0x6d, 0x61, 0x72, 0x6b, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x69, 0x74, 0x79, 0x18, 0x05,
	...
	0x28, 0x09, 0x52, 0x07, 0x70, 0x69, 0x6e, 0x43, 0x6f, 0x64, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}

var (
	file_customers_getbasicinfo_proto_rawDescOnce sync.Once
	file_customers_getbasicinfo_proto_rawDescData = file_customers_getbasicinfo_proto_rawDesc
)

func file_customers_getbasicinfo_proto_rawDescGZIP() []byte {
	file_customers_getbasicinfo_proto_rawDescOnce.Do(func() {
		file_customers_getbasicinfo_proto_rawDescData = protoimpl.X.CompressGZIP(file_customers_getbasicinfo_proto_rawDescData)
	})
...
var file_customers_getbasicinfo_proto_goTypes = []interface{}{
	...
	(*BasicInfoAddress)(nil),     // 2: customers.getbasicinfo.basicInfoAddress
}
var file_customers_getbasicinfo_proto_depIdxs = []int32{
	2, // 0: customers.getbasicinfo.getBasicInfoResponse.curr_address:type_name -> customers.getbasicinfo.basicInfoAddress
	2, // 1: customers.getbasicinfo.getBasicInfoResponse.permanent_address:type_name -> customers.getbasicinfo.basicInfoAddress
...
func file_customers_getbasicinfo_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_customers_getbasicinfo_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_customers_getbasicinfo_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_customers_getbasicinfo_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BasicInfoAddress); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_customers_getbasicinfo_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_customers_getbasicinfo_proto_rawDesc = nil
