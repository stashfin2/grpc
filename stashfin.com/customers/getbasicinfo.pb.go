...
type GetBasicInfoResponse struct {
	...
	CurrAddress      *ContactAddress `protobuf:"bytes,5,opt,name=curr_address,json=currAddress,proto3" json:"curr_address,omitempty"`
	PermanentAddress *ContactAddress `protobuf:"bytes,6,opt,name=permanent_address,json=permanentAddress,proto3" json:"permanent_address,omitempty"`
}
...
func (x *GetBasicInfoResponse) GetCurrAddress() *ContactAddress {
	if x != nil {
...
func (x *GetBasicInfoResponse) GetPermanentAddress() *ContactAddress {
	if x != nil {
...
func (x *ContactAddress) GetHouseFlatNo() string {
	if x != nil {
...
func (x *ContactAddress) GetAddressLine_1() string {
	if x != nil {
...
func (x *ContactAddress) GetAddressLine_2() string {
	if x != nil {
...
func (x *ContactAddress) GetLandmark() string {
	if x != nil {
		return x.Landmark
	}
	return ""
...
func (x *ContactAddress) GetPinCode() string {
	if x != nil {
		return x.PinCode
	}
	return ""
...
var file_customers_getbasicinfo_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xa1, 0x02,
	...
	0x6c, 0x12, 0x49, 0x0a, 0x0c, 0x63, 0x75, 0x72, 0x72, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73,
	0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d,
	...
	,
	...
	0x69, 0x6e, 0x65, 0x32, 0x12, 0x1a, 0x0a, 0x08, 0x6c, 0x61, 0x6e, 0x64, 0x6d, 0x61, 0x72, 0x6b,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x70, 0x69,
	0x6e, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x69,
	0x6e, 0x43, 0x6f, 0x64, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_customers_getbasicinfo_proto_goTypes = []interface{}{
	...
	(*ContactAddress)(nil),       // 2: customers.getbasicinfo.ContactAddress
}
var file_customers_getbasicinfo_proto_depIdxs = []int32{
	2, // 0: customers.getbasicinfo.getBasicInfoResponse.curr_address:type_name -> customers.getbasicinfo.ContactAddress
	2, // 1: customers.getbasicinfo.getBasicInfoResponse.permanent_address:type_name -> customers.getbasicinfo.ContactAddress
