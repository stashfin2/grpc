...
var file_customers_fetchrcprofile_proto_rawDesc = string([]byte{
...
var (
	...
	file_customers_fetchrcprofile_proto_rawDescData []byte
)

func file_customers_fetchrcprofile_proto_rawDescGZIP() []byte {
	file_customers_fetchrcprofile_proto_rawDescOnce.Do(func() {
		file_customers_fetchrcprofile_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_customers_fetchrcprofile_proto_rawDesc), len(file_customers_fetchrcprofile_proto_rawDesc)))
	})
...
var file_customers_fetchrcprofile_proto_goTypes = []any{
...
func file_customers_fetchrcprofile_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_customers_fetchrcprofile_proto_rawDesc), len(file_customers_fetchrcprofile_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
