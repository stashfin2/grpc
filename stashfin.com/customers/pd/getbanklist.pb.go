...
var file_customers_pd_getbanklist_proto_rawDesc = string([]byte{
...
var (
	...
	file_customers_pd_getbanklist_proto_rawDescData []byte
)

func file_customers_pd_getbanklist_proto_rawDescGZIP() []byte {
	file_customers_pd_getbanklist_proto_rawDescOnce.Do(func() {
		file_customers_pd_getbanklist_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_customers_pd_getbanklist_proto_rawDesc), len(file_customers_pd_getbanklist_proto_rawDesc)))
	})
...
var file_customers_pd_getbanklist_proto_goTypes = []any{
...
func file_customers_pd_getbanklist_proto_init() {
	...
	file_customers_pd_getbanklist_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_customers_pd_getbanklist_proto_rawDesc), len(file_customers_pd_getbanklist_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
